...
import { postSkuForecast } from "@/lib/api/forecast";
...
export function useSkuForecast({ skuId, base, horizon }: UseSKUForecastArgs): UseSKUForecast {
        ...
        async function run() {
            ...
            try {
                ...
                for (let i = 0; i < horizon; i++) {
                    ...
                    const resp = await postSkuForecast(skuId, {
                        last_month,
                        lag_1,
                        lag_2,
                        lag_3,
